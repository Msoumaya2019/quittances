/**
 * Panneau QUITTANCES — le contenu de l'onglet « Quittances » de DOCUMENTS.
 *
 * Il vivait auparavant dans `app/(tabs)/quittances.tsx`, quand les quittances
 * avaient leur propre onglet. La barre du bas ne compte plus que quatre entrées,
 * et les quittances sont devenues une **catégorie** de DOCUMENTS : le panneau a
 * donc quitté les routes pour devenir un composant. Rien de son comportement n'a
 * changé — c'est un déplacement, pas une réécriture, et les trois usages
 ...
 *    quittance, tous logements confondus, du plus récent au plus ancien ;
 ...
 *
 * Le composant ne porte ni en-tête ni défilement : c'est l'écran DOCUMENTS qui
 * les fournit, puisque c'est lui qui sait quelle catégorie est affichée.
 */
...
export function PanneauQuittances() {
